...
public class Horiu extends Mob{
	
	
	private AnimatedSprite horiu = new AnimatedSprite(SpriteSheet.horiuAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) horiu.update();
		else horiu.setFrame(0);
