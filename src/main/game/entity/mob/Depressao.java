...
public class Depressao extends Mob{
	
	
	private AnimatedSprite depressao = new AnimatedSprite(SpriteSheet.depressaoAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) depressao.update();
		else depressao.setFrame(0);
