...
public class Motoca extends Mob{
	
	
	private AnimatedSprite motoca = new AnimatedSprite(SpriteSheet.motocaAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) motoca.update();
		else motoca.setFrame(0);
