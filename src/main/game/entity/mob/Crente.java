...
public class Crente extends Mob{
	
	
	private AnimatedSprite crente = new AnimatedSprite(SpriteSheet.crenteAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) crente.update();
		else crente.setFrame(0);
