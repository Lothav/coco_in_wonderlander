...
public class Endriu extends Mob{
	
	
	private AnimatedSprite endriu = new AnimatedSprite(SpriteSheet.endriuAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) endriu.update();
		else endriu.setFrame(0);
