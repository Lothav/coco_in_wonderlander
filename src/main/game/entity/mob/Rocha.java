...
public class Rocha extends Mob{
	
	
	private AnimatedSprite rocha = new AnimatedSprite(SpriteSheet.rochaAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) rocha.update();
		else rocha.setFrame(0);
