...
public class Othav extends Mob{
	
	
	private AnimatedSprite othav = new AnimatedSprite(SpriteSheet.othavAnim, 64, 64, 2);
	...
	public void update() {
		...
		if (walking) othav.update();
		else othav.setFrame(0);
